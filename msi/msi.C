...
char *mu_1_MessageType::values[] = {"data","ackdata","GetS","PutS","GetM","PutM","ackCount","PutAck","PutAckM","OData","Sack","Mack","FwdGetM","FwdGetS","Invreq","InvAck",NULL };
...
char *mu_1__type_0::values[] = {"H_Invalid","H_Shared","H_Modified","H_SD","H_SA","H_MA",NULL };
...
char *mu_1__type_2::values[] = {"P_Invalid","P_Shared","P_Modified","ISD","IMAD","IMA","SMAD","SMA","MIA","SIA","IIA",NULL };
...
const int mu_PutAckM = 15;
const int mu_OData = 16;
const int mu_Sack = 17;
const int mu_Mack = 18;
const int mu_FwdGetM = 19;
const int mu_FwdGetS = 20;
const int mu_Invreq = 21;
const int mu_InvAck = 22;
const int mu_H_Invalid = 23;
const int mu_H_Shared = 24;
const int mu_H_Modified = 25;
const int mu_H_SD = 26;
const int mu_H_SA = 27;
const int mu_H_MA = 28;
const int mu_P_Invalid = 29;
const int mu_P_Shared = 30;
const int mu_P_Modified = 31;
const int mu_ISD = 32;
const int mu_IMAD = 33;
const int mu_IMA = 34;
const int mu_SMAD = 35;
const int mu_SMA = 36;
const int mu_MIA = 37;
const int mu_SIA = 38;
const int mu_IIA = 39;
...
break;
case mu_ackdata:
mu_Send ( mu_Sack, (int)mu_HomeType, (int)mu_p, mu_VC1, mu_msg.mu_val, (int)mu_p, mu_1_CountType_undefined_var );
mu_ps = mu_P_Shared;
mu_pv = mu_msg.mu_val;
break;
default:
...
void SetNextEnabledRule(unsigned & what_rule)
{
  ...
  if (what_rule>=439 && what_rule<445)
...
bool Condition(unsigned r)
{
  ...
  if (r>=439 && r<=444) return R7.Condition(r-439);
...
void Code(unsigned r)
{
  ...
  if (r>=439 && r<=444) { R7.Code(r-439); return; } 
}
int Priority(unsigned short r)
{
  ...
  if (r>=439 && r<=444) { return R7.Priority(); } 
}
char * Name(unsigned r)
{
  ...
  if (r>=439 && r<=444) return R7.Name(r-439);
  return NULL;
}
};
